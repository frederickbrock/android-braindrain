package com.pubnub.braindrain.view;
...
public class CollaborationCanvasView extends View {
    ...
    public CollaborationCanvasView(Context context) {
        super(context);
        init(null, 0);
    }

    public CollaborationCanvasView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public CollaborationCanvasView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw the text.
        canvas.drawText("This is a canvas",
